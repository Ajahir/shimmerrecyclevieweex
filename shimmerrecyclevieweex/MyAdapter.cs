...
namespace shimmerrecyclevieweex
{
    ...
    {
        private playerDetails _friendsDetails;
        private Context context;

        public MyAdapter(playerDetails friendsDetails, Context context)
        {
            _friendsDetails = friendsDetails;
            this.context = context;
        }

        public override int ItemCount => _friendsDetails.Numbplayer;
        ...
        {
            View view = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.listDetails, parent, false);
    ...
    class MyViewHolder : RecyclerView.ViewHolder
    {
        ...
        internal void Binddata(playerDetails friendsDetails, int position)
        {
